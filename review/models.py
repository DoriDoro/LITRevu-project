...
class Ticket(models.Model):
    ...
    description = models.TextField(
        max_length=2048,
        verbose_name=_("description of ticket"),
        blank=True,
        null=True
    )
    ...
    time_created = models.DateTimeField(auto_now_add=True, verbose_name=_("ticket created at"))
...
class Review(models.Model):
    ...
    time_created = models.DateTimeField(auto_now_add=True, verbose_name=_("review created at"))
